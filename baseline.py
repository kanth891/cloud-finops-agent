...
def main():
    ...
    # ──────────────────────────────────────────────────────────────────────
    # Hugging Face Spaces expects a web server on port 7860. 
    # If the script just exits, it throws a "Runtime Error".
    print("\n[INFO] Baseline test complete. Starting API Server to keep Space alive...")
    import uvicorn
    from app import app
